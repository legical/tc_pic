    ...
    <div class="sidebar_inner">
      ...
      <div class="profile_info">
        <div class="profile_img">
          <img src="../img/Profile_id.jpg" alt="">
        </div>
...
<%--      退出登录--%>
  ...
  <div class="main_container">
    ...
    <div class="content">
      ...
      <div class="item">
        <h3 style="color:indianred">用户ID</h3><br>
        <h4 >${user.getId()}</h4>
      </div>
      <div class="item">
        <h3 style="color:cadetblue">用户名</h3><br>
        <h4 >${user.getUserName()}</h4>
      </div>
      <div class="item">
        <h3 style="color:goldenrod">真实姓名</h3><br>
        <h4 >${user.getRealName()}</h4>
      </div>
      <div class="item">
        <h3 style="color:coral">性别</h3><br>
        <h4 >${user.getSex()}</h4>
      </div>
      <div class="item">
        <h3 style="color:lightpink">出生日期</h3><br>
        <h4 >${user.getBirthday()}</h4>
      </div>
      <div class="item">
        <h3 style="color:seagreen">身份证号</h3><br>
        <h4 >${user.getIdCard()}</h4>
      </div>
      <div class="item">
                ...
                <form action="${pageContext.request.contextPath}/user/modify" method="post">
                  <div class="bottom">
                    ...
                    <div>
                      ...
                      <input type="number" style="display:none" name="inden" value="0"/>
                    </div>
                    <div class="row">
