(function ($) {
	...
	class Silence {
		constructor() {
			this.defaluts = {
				...
				topInfo: {
					title: '色相事一刹那',
					text: '戒骄戒躁，久久为功',
					github: "https://github.com/legical",
					// weibo: "",
					// telegram: "",
					// music: "",
					// twitter: "",
		...
		buildCustomElements() {
			...
			$title.html($title.html().replace(`江南无所有 | ${autherName}`, `${blogTitle}`));
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/leebri/p/poetry.html">我？</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="http://speed.neu.edu.cn">测速</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
