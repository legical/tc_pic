...
<div class="container">
  ...
  <div class="login-content">
    <form action="${pageContext.request.contextPath}/user/register">
      ...
      <h2 class="title">注册</h2><br>
      <h3 class="title">${registererror}</h3><br>
      ...
      <a href="../login.jsp">已有账户，去登录</a>
      <input type="submit" class="btn" value="注册" οnclick="return checkLoginForm()">
    </form>
  </div>
</div>
